 ...
 *********************/
/**
*  META_MISC_EX_CheckRamDiskExist:
*  Brief: 
*      Check ram disk existing or not.
*  Parameters:
*      [in] meta_handler: meta handler
*      [in] timeout: time out (ms)
*      [out]cExist: 0: ramdisk is not existing. 1: ramdisk is existing.
*  Return Value:
*      META_SUCCESS: ram disk is existing
*      META_FAILED:  ram disk is not existing  
**/
...
/**
*  META_MISC_EX_RamDisk_GetSize:
*  Brief: 
*      Get ram disk size.
*  Parameters:
*      [in] meta_handler: meta handler
*      [in] timeout: time out (ms)
*      [out] i4Size: ram disk size
*  Return Value:
*      META_SUCCESS: ram disk size getting successed
*      META_FAILED:  ram disk size getting failed  
**/
...
/**
*  META_MISC_EX_RamDisk_Backup_To_File:
*  Brief:
*      Back up ram disk to file
*  Parameters:
*      [in] meta_handler: meta handler
*      [in] local_filepath: the path and file name to store the back up binary image
*      [in] cb_progress: the callback of progress report
*           typedef int (__stdcall *CALLBACK_META_FAT_PROGRESS)(unsigned char percent, int sent_bytes, int total_bytes, const short token, void *usr_arg);
*      [in] cb_progress_arg: the arugement of callback of progress report
*      [out] p_token: identify token 
*      [in] p_stopflag: the stop control flag, when the flag set to true. The back up progress will stop.
*  Return Value:
*      META_SUCCESS: back up successfuly
*      META_FAILED:  back up failed  
**/
