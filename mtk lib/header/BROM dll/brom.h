...
#if defined(__GNUC__)
int __stdcall Brom_ConnectByPath(unsigned int *p_brom_handle, FLASHTOOL_API_HANDLE_T  *p_ft_handle, char*  dev_path, BBCHIP_TYPE  bbchip_type, EXT_CLOCK  ext_clock, int *p_bootstop, unsigned int ms_boot_timeout, unsigned int max_start_cmd_retry_count, CONNECT_METHOD com_type );
#endif
#if defined(_WIN32)
int __stdcall Brom_Connect(unsigned int *p_brom_handle, FLASHTOOL_API_HANDLE_T  *p_ft_handle, unsigned char  com_port, BBCHIP_TYPE  bbchip_type, EXT_CLOCK  ext_clock, int *p_bootstop, unsigned int ms_boot_timeout, unsigned int max_start_cmd_retry_count, CONNECT_METHOD com_type);
#elif defined(__GNUC__)
int __stdcall Brom_Connect(unsigned int *p_brom_handle, FLASHTOOL_API_HANDLE_T  *p_ft_handle, char*  com_port, BBCHIP_TYPE  bbchip_type, EXT_CLOCK  ext_clock, int *p_bootstop, unsigned int ms_boot_timeout, unsigned int max_start_cmd_retry_count, CONNECT_METHOD com_type);
#endif

int __stdcall Brom_Connect(unsigned int *p_brom_handle, FLASHTOOL_API_HANDLE_T  *p_ft_handle, unsigned char  com_port, BBCHIP_TYPE  bbchip_type, EXT_CLOCK  ext_clock, int *p_bootstop, unsigned int ms_boot_timeout, unsigned int max_start_cmd_retry_count, CONNECT_METHOD com_type );
int __stdcall Brom_DisConnect(unsigned int *p_brom_handle, FLASHTOOL_API_HANDLE_T  *p_ft_handle);
int __stdcall Brom_WriteEfuseCommon(unsigned int brom_handle, FLASHTOOL_API_HANDLE_T ft_handle, const Efuse_Common_Arg *common_arg, bool error_log_en);
int __stdcall Brom_WriteEfuseSecure(unsigned int brom_handle, FLASHTOOL_API_HANDLE_T ft_handle, const Efuse_Secure_Arg *secure_arg, bool error_log_en );
int __stdcall Brom_WriteEfuseLock(unsigned int brom_handle, FLASHTOOL_API_HANDLE_T ft_handle, const Efuse_Lock_Arg *lock_arg, bool error_log_en);
int __stdcall Brom_ReadEfuseAll(unsigned int brom_handle, FLASHTOOL_API_HANDLE_T ft_handle, Efuse_Common_Arg *common_arg, Efuse_Secure_Arg *secure_arg, Efuse_Lock_Arg *lock_arg, bool error_log_en );
