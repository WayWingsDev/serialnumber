...
extern kal_bool WritePDU ( E_COM_NUMBER eComPort, kal_uint8* ptr, kal_uint16 length );
extern kal_bool GetDeviceData ( E_COM_NUMBER eComPort );
extern kal_int32 ReadPDU ( E_COM_NUMBER eComPort, kal_uint8* ptr, kal_uint16 length );
...
extern void EnQueue ( S_RS232_QUEUE *pQueue, kal_uint8* pData, kal_uint32 length );
extern kal_uint32 DeQueue ( S_RS232_QUEUE *pQueue, kal_uint8* pData, kal_uint32 length );
extern kal_uint8 GetByteQueue ( S_RS232_QUEUE *pQueue );
extern void FlushQueue ( S_RS232_QUEUE *pQueue );
extern kal_bool GetRawData( kal_uint8 *ch );
