...
{
	AtParaType  type;
	kal_uint8 *str_value;				//string type, maybe pdu
...
typedef struct {
	...
	kal_uint8 *pstrReceResult;
	kal_uint8 *pstrExpectedResult;
	kal_uint32 iTimeOut;
...
extern kal_bool WriteBarcodeATMode ( E_COM_NUMBER eComPort, kal_uint8* pstrBarcode );
extern kal_bool SDSATMode(E_COM_NUMBER eComPort);
extern kal_bool WriteBarcodeATMode_r ( E_COM_NUMBER eComPort, kal_uint8* pBarcode );
extern kal_bool SDSATMode_r(E_COM_NUMBER eComPort);
extern kal_bool ReadBarcodeATMode ( E_COM_NUMBER eComPort, kal_uint8* pBarcode, kal_uint32* len );
...
extern kal_bool WriteCDROMATMode ( E_COM_NUMBER eComPort,  kal_uint8 id );
